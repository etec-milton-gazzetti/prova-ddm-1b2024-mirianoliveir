...
//import { useFonts } from '@expo-google-fonts/Cinzel';
...
return (
  <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
    <ImageBackground source={fundo} resizeMode="cover" style={{ justifyContent: 'center', flex: 1, width: "100%" }}>
      <Text style={{ alignItems: 'center', justifyContent: 'center', fontFamily: 'fonte', fontSize: 80 }}>Guerra Fria</Text>
      ...
      <TouchableOpacity style={{
        ...
        backgroundColor: '#DDDDDD',
        padding: 10,
      }} title='Page' onPress={() => navigation.navigate("Page")} >
        <Text>História</Text>
